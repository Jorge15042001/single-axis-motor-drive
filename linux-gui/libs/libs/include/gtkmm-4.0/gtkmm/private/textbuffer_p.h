...
protected:
  ...
  static void insert_paintable_callback(GtkTextBuffer* self, GtkTextIter* p0, GdkPaintable* p1);
  ...
  static void paste_done_callback(GtkTextBuffer* self, GdkClipboard* p0);
  static void redo_callback(GtkTextBuffer* self);
  static void undo_callback(GtkTextBuffer* self);
