...
{
  return Glib::make_refptr_for_instance<Gtk::GestureDrag>( dynamic_cast<Gtk::GestureDrag*> (Glib::wrap_auto ((GObject*)(object), take_copy)) );
...
Glib::RefPtr<GestureDrag> GestureDrag::create()
{
