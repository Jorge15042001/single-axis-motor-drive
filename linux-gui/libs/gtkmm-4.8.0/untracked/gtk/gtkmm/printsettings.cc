...
void PrintSettings::save_to_key_file(const Glib::RefPtr<Glib::KeyFile>& key_file, const Glib::ustring& group_name) const
{
...
void PrintSettings::set_printer(const Glib::ustring& printer)
{
...
void PrintSettings::set_print_pages(PrintPages pages)
{
