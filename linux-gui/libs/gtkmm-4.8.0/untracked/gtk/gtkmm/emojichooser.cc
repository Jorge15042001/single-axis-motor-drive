...
#include <gtkmm/private/emojichooser_p.h>
...
static void EmojiChooser_signal_emoji_picked_callback(GtkEmojiChooser* self, const gchar* p0,void* data)
{
  ...
  auto obj = dynamic_cast<EmojiChooser*>(Glib::ObjectBase::_get_current_wrapper((GObject*) self));
...
void EmojiChooser_Class::class_init_function(void* g_class, void* class_data)
{
